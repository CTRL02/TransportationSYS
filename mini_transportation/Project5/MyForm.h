...
namespace Project5 {
    ...
    private: System::Windows::Forms::PictureBox^ pictureBox22;
           bool checkGraph; //UnDirected= true                   Directed= false
    public:
        MyForm(void)
        {
            InitializeComponent();
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->check = (gcnew System::Windows::Forms::Panel());
            ...
            this->pictureBox22->Location = System::Drawing::Point(17, 18);
            this->pictureBox22->Margin = System::Windows::Forms::Padding(4);
            this->pictureBox22->Name = L"pictureBox22";
            this->pictureBox22->Size = System::Drawing::Size(96, 78);
            ...
            this->check->Controls->Add(this->button12);
            this->check->Controls->Add(this->button13);
            this->check->Controls->Add(this->label4);
            this->check->Controls->Add(this->pictureBox21);
            ...
            this->check->Size = System::Drawing::Size(1305, 650);
            ...
            this->button12->Location = System::Drawing::Point(677, 468);
            this->button12->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
            this->button12->Name = L"button12";
            this->button12->Size = System::Drawing::Size(308, 54);
            this->button12->TabIndex = 6;
            this->button12->Text = L"UnDirected";
            this->button12->UseVisualStyleBackColor = false;
            this->button12->Click += gcnew System::EventHandler(this, &MyForm::button12_Click_2);
            // 
            // button13
            // 
            ...
            this->button13->Location = System::Drawing::Point(528, 369);
            this->button13->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
            this->button13->Name = L"button13";
            this->button13->Size = System::Drawing::Size(304, 52);
            this->button13->TabIndex = 5;
            this->button13->Text = L"Directed";
            ...
            this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 24, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->label4->Location = System::Drawing::Point(399, 294);
            this->label4->Name = L"label4";
            this->label4->Size = System::Drawing::Size(511, 46);
            this->label4->TabIndex = 4;
            this->label4->Text = L"Hi user, Welcome to وصلني";
            ...
            this->pictureBox21->Size = System::Drawing::Size(1305, 650);
            ...
            this->button20->BackgroundImageLayoutChanged += gcnew System::EventHandler(this, &MyForm::button20_BackgroundImageLayoutChanged);
            ...
            this->DeleteCity->ForeColor = System::Drawing::SystemColors::ControlText;
            ...
            this->textBox7->Enter += gcnew System::EventHandler(this, &MyForm::textBox7_Enter);
            // 
            // pictureBox13
            // 
...
#pragma endregion
    ...
    private: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        std::string strEdge = msclr::interop::marshal_as<std::string>(edge);
        bool boolCheck = graphPtr->checkEdge(strEdge);
        if (source == ""||destination == "" ||edge == "")
            MessageBox::Show("No data was entered...!");
        else {

            if (boolCheck == false) {
                MessageBox::Show("Invalid data was entered in destnace .....!");
            }
            else
            {
                ...
                {
                    graphPtr->addEdgesDirected(strSrc, strDest, distance);
                }
            }
        }
    ...
    private: System::Void button9_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        if (checkGraph)
        {
            ...
            cppString = graphPtr->cmdDisplay(); //store whole adjacency list in string
        }
        else
        {
            graphPtr->displayGraphDirected(visualGraph);
            cppString = graphPtr->cmdDisplayDirected();
        }
...
private: System::Void button14_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    if (checkGraph)
    {
        ...
        if (!citiesPassed.empty()) {
            ...
            MessageBox::Show("Sorry the distination isn't connected..!");
        }
    }
    else
    {
        std::vector<std::string> citiesPassed = graphPtr->dijkstraDirected(strSrc, strDest);
        if (!citiesPassed.empty()) {
            int totalDistance = graphPtr->computeTotalDistanceDirected(citiesPassed);
            System::String^ strTotalDistance = System::Convert::ToString(totalDistance);
            label12->Text = "The total distance of the shortest path is: " + strTotalDistance + "\n";
            System::String^ sysString = msclr::interop::marshal_as<System::String^>(graphPtr->showCities(citiesPassed));
            label12->Text += sysString;
            graphPtr->displayShortestPathDirected(citiesPassed, VisShort);
        }
        else {
            MessageBox::Show("Sorry the distination isn't connected..!");
        }
...
private: System::Void button20_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    {
        graphPtr->addCityDirected(addedCity);
    }
}
...
private: System::Void button23_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    {
        graphPtr->DeleteCityDirected(deletedCity);
    }
...
private: System::Void deleteEdge_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
    ...
    {
        graphPtr->DeleteEdgeDirected(deletedCity1, deletedCity2);
    }
}
...
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
    PlaySound(TEXT("click.wav"), NULL, SND_FILENAME | SND_ASYNC);
    std::string basicBfsString;
    if (checkGraph)
    {
        basicBfsString = graphPtr->BFS();
    }
    else
    {
        basicBfsString = graphPtr->BFSDirected();
    }
...
private: System::Void button7_Click_1(System::Object^ sender, System::EventArgs^ e) {
    PlaySound(TEXT("click.wav"), NULL, SND_FILENAME | SND_ASYNC);
    std::string basicDfsString;
    if (checkGraph)
    {
        basicDfsString = graphPtr->DFS();
    }
    else
    {
        basicDfsString = graphPtr->DFSDirected();
    }
...
private: System::Void button12_Click_2(System::Object^ sender, System::EventArgs^ e) {
    PlaySound(TEXT("click.wav"), NULL, SND_FILENAME | SND_ASYNC);
    checkGraph = true;
    panel2->BringToFront();
    panel2->Show();
...
private: System::Void textBox7_Enter(System::Object^ sender, System::EventArgs^ e) {
    if (textBox7->Text == "Enter City...") {
        textBox7->Text = "";
    }
}
private: System::Void button20_BackgroundImageLayoutChanged(System::Object^ sender, System::EventArgs^ e) {
}
